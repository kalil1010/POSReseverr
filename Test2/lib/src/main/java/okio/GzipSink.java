...
public final class GzipSink implements Sink {
    ...
    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "deflater", imports = {}))
