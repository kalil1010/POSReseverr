...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        int beginSegment$iv = SegmentedByteString2.segment(this, beginIndex);
        int endSegment$iv = SegmentedByteString2.segment(this, endIndex - 1);
    ...
    public byte internalGet$okio(int pos) {
        ...
        int segment$iv = SegmentedByteString2.segment(this, pos);
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        ...
        int s$iv$iv = SegmentedByteString2.segment(this, offset);
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        int endIndex$iv$iv = offset + byteCount;
        int s$iv$iv = SegmentedByteString2.segment($this$commonRangeEquals$iv, offset);
        int pos$iv$iv = offset;
        while (pos$iv$iv < endIndex$iv$iv) {
