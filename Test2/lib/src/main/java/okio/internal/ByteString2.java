            ...
            if (c >= b2 && c <= (b = (byte) 90)) {
                ...
                while (i2 < lowercase.length) {
                    ...
                    if (c2 < b2 || c2 > b) {
                        ...
                        lowercase[i2] = (byte) (c2 + ISO7816.INS_VERIFY);
                        i2++;
                    }
                }
    ...
    public static final ByteString commonToAsciiUppercase(ByteString commonToAsciiUppercase) {
        ...
        for (int i = 0; i < commonToAsciiUppercase.getData$okio().length; i++) {
            ...
            if (c >= b2 && c <= (b = (byte) 122)) {
                ...
                Intrinsics.checkNotNullExpressionValue(lowercase, "java.util.Arrays.copyOf(this, size)");
                int i2 = i + 1;
                lowercase[i] = (byte) (c + ISO7816.INS_CREATE_FILE);
                while (i2 < lowercase.length) {
                    byte c2 = lowercase[i2];
                    if (c2 < b2 || c2 > b) {
                        i2++;
                    } else {
                        lowercase[i2] = (byte) (c2 + ISO7816.INS_CREATE_FILE);
                        i2++;
                    }
                }
                return new ByteString(lowercase);
  ...
  0x063f: PHI (r25v3 'j' int) = (r25v0 'j' int), (r25v1 'j' int), (r25v4 'j' int) binds: [B:656:0x06ba, B:629:0x0681, B:599:0x063d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final int codePointIndexToCharIndex(byte[] r29, int r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: okio.internal.ByteString2.codePointIndexToCharIndex(byte[], int):int");
    }
}
