...
public final class SegmentedByteString2 {
    ...
    public static final void forEachSegment(SegmentedByteString forEachSegment, Functions17<? super byte[], ? super Integer, ? super Integer, Unit> action) {
    ...
    public static final void forEachSegment(SegmentedByteString $this$forEachSegment, int beginIndex, int endIndex, Functions17<? super byte[], ? super Integer, ? super Integer, Unit> functions17) {
        ...
        while (pos < endIndex) {
            ...
            functions17.invoke($this$forEachSegment.getSegments()[s], Integer.valueOf(offset), Integer.valueOf(byteCount));
            pos += byteCount;
            s++;
        }
    }
