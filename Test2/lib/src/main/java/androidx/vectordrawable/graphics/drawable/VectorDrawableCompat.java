...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static VectorDrawableCompat create(Resources res, int resId, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int type;
