...
public class ViewCompat {
    ...
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0127R.id.accessibility_custom_action_0, C0127R.id.accessibility_custom_action_1, C0127R.id.accessibility_custom_action_2, C0127R.id.accessibility_custom_action_3, C0127R.id.accessibility_custom_action_4, C0127R.id.accessibility_custom_action_5, C0127R.id.accessibility_custom_action_6, C0127R.id.accessibility_custom_action_7, C0127R.id.accessibility_custom_action_8, C0127R.id.accessibility_custom_action_9, C0127R.id.accessibility_custom_action_10, C0127R.id.accessibility_custom_action_11, C0127R.id.accessibility_custom_action_12, C0127R.id.accessibility_custom_action_13, C0127R.id.accessibility_custom_action_14, C0127R.id.accessibility_custom_action_15, C0127R.id.accessibility_custom_action_16, C0127R.id.accessibility_custom_action_17, C0127R.id.accessibility_custom_action_18, C0127R.id.accessibility_custom_action_19, C0127R.id.accessibility_custom_action_20, C0127R.id.accessibility_custom_action_21, C0127R.id.accessibility_custom_action_22, C0127R.id.accessibility_custom_action_23, C0127R.id.accessibility_custom_action_24, C0127R.id.accessibility_custom_action_25, C0127R.id.accessibility_custom_action_26, C0127R.id.accessibility_custom_action_27, C0127R.id.accessibility_custom_action_28, C0127R.id.accessibility_custom_action_29, C0127R.id.accessibility_custom_action_30, C0127R.id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0127R.id.tag_accessibility_actions);
        if (actions == null) {
            ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
            view.setTag(C0127R.id.tag_accessibility_actions, actions2);
            return actions2;
        }
        return actions;
    }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (listener == null) {
                ...
                v.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.1
                    ViewOnApplyWindowInsetsListenerC01851() {
                    }
    ...
    class ViewOnApplyWindowInsetsListenerC01851 implements View.OnApplyWindowInsetsListener {
        ViewOnApplyWindowInsetsListenerC01851() {
        }
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0127R.id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0127R.id.tag_unhandled_key_listeners, viewListeners);
            }
            View.OnUnhandledKeyEventListener fwListener = new View.OnUnhandledKeyEventListener() { // from class: androidx.core.view.ViewCompat.2
                ViewOnUnhandledKeyEventListenerC01862() {
                }

                @Override // android.view.View.OnUnhandledKeyEventListener
                public boolean onUnhandledKeyEvent(View v2, KeyEvent event) {
                    return onUnhandledKeyEventListenerCompat.onUnhandledKeyEvent(v2, event);
                }
            };
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0127R.id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0127R.id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    class ViewOnUnhandledKeyEventListenerC01862 implements View.OnUnhandledKeyEventListener {
        ViewOnUnhandledKeyEventListenerC01862() {
        }
    ...
    class C01873 extends AccessibilityViewProperty<Boolean> {
        C01873(int tagKey, Class cls, int frameworkMinimumSdk) {
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0127R.id.tag_screen_reader_focusable, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.3
            C01873(int tagKey, Class cls, int frameworkMinimumSdk) {
                super(tagKey, cls, frameworkMinimumSdk);
            }
    ...
    class C01884 extends AccessibilityViewProperty<CharSequence> {
        C01884(int tagKey, Class cls, int contentChangeType, int frameworkMinimumSdk) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0127R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28) { // from class: androidx.core.view.ViewCompat.4
            C01884(int tagKey, Class cls, int contentChangeType, int frameworkMinimumSdk) {
                super(tagKey, cls, contentChangeType, frameworkMinimumSdk);
            }
    ...
    class C01895 extends AccessibilityViewProperty<Boolean> {
        C01895(int tagKey, Class cls, int frameworkMinimumSdk) {
            super(tagKey, cls, frameworkMinimumSdk);
        }
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0127R.id.tag_accessibility_heading, Boolean.class, 28) { // from class: androidx.core.view.ViewCompat.5
            C01895(int tagKey, Class cls, int frameworkMinimumSdk) {
                super(tagKey, cls, frameworkMinimumSdk);
            }
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m11at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0127R.id.tag_unhandled_key_event_manager);
            if (manager == null) {
                UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
                root.setTag(C0127R.id.tag_unhandled_key_event_manager, manager2);
                return manager2;
            }
            return manager;
        }
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0127R.id.tag_unhandled_key_listeners);
            if (viewListeners != null) {
