...
public final class View2 {
    ...
    public static final void doOnLayout(View doOnLayout, final Functions2<? super View, Unit> action) {
    ...
    public static final OneShotPreDrawListener doOnPreDraw(final View doOnPreDraw, final Functions2<? super View, Unit> action) {
    ...
    public static final void doOnAttach(final View doOnAttach, final Functions2<? super View, Unit> action) {
    ...
    public static final void doOnDetach(final View doOnDetach, final Functions2<? super View, Unit> action) {
    ...
    public static final Runnable postDelayed(View postDelayed, long delayInMillis, final Functions<Unit> action) {
    ...
    public static final Runnable postOnAnimationDelayed(View postOnAnimationDelayed, long delayInMillis, final Functions<Unit> action) {
    ...
    public static final void updateLayoutParams(View updateLayoutParams, Functions2<? super ViewGroup.LayoutParams, Unit> block) {
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View updateLayoutParams, Functions2<? super T, Unit> block) {
        Intrinsics.checkParameterIsNotNull(updateLayoutParams, "$this$updateLayoutParams");
        Intrinsics.checkParameterIsNotNull(block, "block");
