...
class TypefaceCompatBaseImpl {
    ...
    class C01481 implements StyleExtractor<FontsContractCompat.FontInfo> {
        C01481() {
        }
    ...
    class C01492 implements StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry> {
        C01492() {
        }
