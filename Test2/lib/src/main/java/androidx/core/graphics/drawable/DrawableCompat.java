...
public final class DrawableCompat {
    ...
    public static boolean setLayoutDirection(Drawable drawable, int layoutDirection) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
