...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) throws Resources.NotFoundException {
            ...
            int maxWidth = res.getDimensionPixelSize(C0127R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0127R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) throws Resources.NotFoundException {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0127R.id.notification_background, "setBackgroundResource", C0127R.drawable.notification_bg_low);
                    contentView.setInt(C0127R.id.icon, "setBackgroundResource", C0127R.drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0127R.id.notification_background, "setBackgroundResource", C0127R.drawable.notification_bg);
                    contentView.setInt(C0127R.id.icon, "setBackgroundResource", C0127R.drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0127R.id.icon, 0);
                    contentView.setImageViewBitmap(C0127R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0127R.id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0127R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0127R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT < 21) {
                        contentView.setImageViewBitmap(C0127R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    } else {
                        Bitmap smallBit = createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor());
                        contentView.setImageViewBitmap(C0127R.id.right_icon, smallBit);
                    }
                    contentView.setViewVisibility(C0127R.id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0127R.id.icon, 0);
                if (Build.VERSION.SDK_INT < 21) {
                    contentView.setImageViewBitmap(C0127R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                } else {
                    int backgroundSize2 = res.getDimensionPixelSize(C0127R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0127R.dimen.notification_big_circle_margin);
                    int iconSize2 = res.getDimensionPixelSize(C0127R.dimen.notification_small_icon_size_as_large);
                    ...
                    contentView.setImageViewBitmap(C0127R.id.icon, smallBit2);
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0127R.id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0127R.id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide2 = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0127R.id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0127R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C0127R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C0127R.id.info, res.getString(C0127R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C0127R.id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0127R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0127R.id.info, 8);
                hasRightSide = hasRightSide2;
            }
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0127R.id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0127R.id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0127R.id.text2, 0);
                    showLine2 = true;
                } else {
                    contentView.setViewVisibility(C0127R.id.text2, 8);
                    showLine2 = false;
                }
            } else {
                showLine2 = false;
            ...
            if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    float subTextSize = res.getDimensionPixelSize(C0127R.dimen.notification_subtext_size);
                    contentView.setTextViewTextSize(C0127R.id.text, 0, subTextSize);
                }
                contentView.setViewPadding(C0127R.id.line1, 0, 0, 0, 0);
            }
            if (this.mBuilder.getWhenIfShowing() != 0) {
                if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0127R.id.chronometer, 0);
                    contentView.setLong(C0127R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(C0127R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                        contentView.setChronometerCountDown(C0127R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    contentView.setViewVisibility(C0127R.id.time, 0);
                    contentView.setLong(C0127R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                hasRightSide = true;
            }
            contentView.setViewVisibility(C0127R.id.right_side, hasRightSide ? 0 : 8);
            contentView.setViewVisibility(C0127R.id.line3, showLine3 ? 0 : 8);
            return contentView;
        }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0127R.drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0127R.id.notification_main_column);
            outerView.addView(C0127R.id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0127R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0127R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0127R.id.title, 8);
            outerView.setViewVisibility(C0127R.id.text2, 8);
            outerView.setViewVisibility(C0127R.id.text, 8);
        }

        private int calculateTopPadding() throws Resources.NotFoundException {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0127R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0127R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C0127R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0127R.id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C0127R.id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C0127R.id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0127R.id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C0127R.layout.notification_action_tombstone : C0127R.layout.notification_action);
            button.setImageViewBitmap(C0127R.id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0127R.color.notification_action_color_filter)));
            button.setTextViewText(C0127R.id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0127R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0127R.id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m69clone() {
