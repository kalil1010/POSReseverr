...
import androidx.cardview.C0095R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0095R.attr.cardViewStyle);
    }
    ...
    public CardView(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0095R.styleable.CardView, defStyleAttr, C0095R.style.CardView);
        if (a.hasValue(C0095R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0095R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                color = getResources().getColor(C0095R.color.cardview_light_background);
            } else {
                color = getResources().getColor(C0095R.color.cardview_dark_background);
            }
            backgroundColor = ColorStateList.valueOf(color);
        }
        int themeColorBackground2 = C0095R.styleable.CardView_cardCornerRadius;
        float radius = a.getDimension(themeColorBackground2, 0.0f);
        float elevation = a.getDimension(C0095R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation2 = a.getDimension(C0095R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0095R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0095R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0095R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a.getDimensionPixelSize(C0095R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a.getDimensionPixelSize(C0095R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a.getDimensionPixelSize(C0095R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a.getDimensionPixelSize(C0095R.styleable.CardView_contentPaddingBottom, defaultPadding);
        if (elevation <= maxElevation2) {
            maxElevation = maxElevation2;
        } else {
            maxElevation = elevation;
        }
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0095R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0095R.styleable.CardView_android_minHeight, 0);
        a.recycle();
    ...
    class C00961 implements CardViewDelegate {
        private Drawable mCardBackground;
