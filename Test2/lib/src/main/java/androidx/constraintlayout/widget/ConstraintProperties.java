    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (leftId != -1 || rightId != -1) {
            ...
            if (leftId != -1 && rightId != -1) {
                ...
                ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
                if (i != -1) {
                    leftProp.connect(2, layoutParams2.rightToRight, 2, 0);
                } else {
                    int i2 = layoutParams2.leftToLeft;
                    ConstraintLayout.LayoutParams layoutParams3 = this.mParams;
                    if (i2 != -1) {
                        rightProp.connect(1, layoutParams3.leftToLeft, 1, 0);
                    }
                }
            }
            removeConstraints(1);
            ...
            if (startId != -1 || endId != -1) {
                ...
                if (startId != -1 && endId != -1) {
                    ...
                    if (i3 != -1) {
                        startProp.connect(7, layoutParams4.rightToRight, 7, 0);
                    } else {
                        int i4 = layoutParams4.leftToLeft;
                        ConstraintLayout.LayoutParams layoutParams5 = this.mParams;
                        if (i4 != -1) {
                            endProp.connect(6, layoutParams5.leftToLeft, 6, 0);
                        }
                    }
                }
            }
