...
public class KeyTrigger extends Key {
    ...
    public void load(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0126R.styleable.KeyTrigger);
        ...
        if (fireNegative && this.mNegativeCross != null) {
            if (this.mFireNegativeCross == null) {
                try {
                    ...
                    Log.e("KeyTrigger", "Could not find method \"" + this.mNegativeCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
                }
            }
            try {
                this.mFireNegativeCross.invoke(call, new Object[0]);
            } catch (Exception e2) {
                Log.e("KeyTrigger", "Exception in call \"" + this.mNegativeCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
            }
        }
        if (firePositive && this.mPositiveCross != null) {
            if (this.mFirePositiveCross == null) {
                try {
                    ...
                    Log.e("KeyTrigger", "Could not find method \"" + this.mPositiveCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
                }
            }
            try {
                this.mFirePositiveCross.invoke(call, new Object[0]);
            } catch (Exception e4) {
                Log.e("KeyTrigger", "Exception in call \"" + this.mPositiveCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
            }
        }
        if (fireCross && this.mCross != null) {
            if (this.mFireCross == null) {
                try {
                    ...
                    Log.e("KeyTrigger", "Could not find method \"" + this.mCross + "\"on class " + call.getClass().getSimpleName() + StringUtils.SPACE + Debug.getName(call));
                }
            }
            try {
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0126R.styleable.KeyTrigger_framePosition, 8);
            mAttrMap.append(C0126R.styleable.KeyTrigger_onCross, 4);
            mAttrMap.append(C0126R.styleable.KeyTrigger_onNegativeCross, 1);
            mAttrMap.append(C0126R.styleable.KeyTrigger_onPositiveCross, 2);
            mAttrMap.append(C0126R.styleable.KeyTrigger_motionTarget, 7);
            mAttrMap.append(C0126R.styleable.KeyTrigger_triggerId, 6);
            mAttrMap.append(C0126R.styleable.KeyTrigger_triggerSlack, 5);
            mAttrMap.append(C0126R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            mAttrMap.append(C0126R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            mAttrMap.append(C0126R.styleable.KeyTrigger_triggerReceiver, 11);
        }
