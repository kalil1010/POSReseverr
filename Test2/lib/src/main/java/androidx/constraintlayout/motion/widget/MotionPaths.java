...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float startCenterX = startTimePoint.f29x + (f2 / 2.0f);
        float startCenterY = startTimePoint.f30y + (f4 / 2.0f);
        ...
        this.f29x = (int) ((r15 + (pathVectorX * position)) - ((scaleX * scaleWidth) / 2.0f));
        this.f30y = (int) ((r3 + (pathVectorY * position)) - ((scaleY * scaleHeight) / 2.0f));
    ...
    void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float pathVectorX = endCenterX - startCenterX;
        float pathVectorY = endCenterY - startCenterY;
        this.f29x = (int) ((r11 + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f));
        this.f30y = (int) ((r15 + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f));
        ...
        this.mMode = 1;
        float f = (int) ((startTimePoint.f29x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f));
        this.f29x = f;
        float f2 = (int) ((startTimePoint.f30y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f));
        this.f30y = f2;
        this.f29x = f + normalX;
        this.f30y = f2 + normalY;
        this.mKeyFrameEasing = Easing.getInterpolator(c.mTransitionEasing);
        this.mPathMotionArc = c.mPathMotionArc;
    }
