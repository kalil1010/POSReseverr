...
class FragmentTransition {
    ...
    public static void calculateFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) throws Resources.NotFoundException {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            FragmentTransaction.C0235Op op = transaction.mOps.get(opNum);
    ...
    */
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r22, androidx.fragment.app.FragmentTransaction.C0235Op r23, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r24, boolean r25, boolean r26) throws android.content.res.Resources.NotFoundException {
        /*
