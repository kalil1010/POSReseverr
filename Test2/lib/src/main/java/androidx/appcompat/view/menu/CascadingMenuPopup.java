...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.1
        ViewTreeObserverOnGlobalLayoutListenerC00361() {
        }
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.2
        ViewOnAttachStateChangeListenerC00372() {
        }
    ...
    class ViewTreeObserverOnGlobalLayoutListenerC00361 implements ViewTreeObserver.OnGlobalLayoutListener {
        ViewTreeObserverOnGlobalLayoutListenerC00361() {
        }
    ...
    class ViewOnAttachStateChangeListenerC00372 implements View.OnAttachStateChangeListener {
        ViewOnAttachStateChangeListenerC00372() {
        }
    ...
    class C00383 implements MenuItemHoverListener {
        C00383() {
        }
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) layoutInflaterFrom.inflate(C0005R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
