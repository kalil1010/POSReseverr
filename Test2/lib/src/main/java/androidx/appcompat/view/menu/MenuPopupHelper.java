...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0005R.attr.popupMenuStyle, 0);
    }
    ...
    private MenuPopup createPopup() throws Resources.NotFoundException {
        ...
        int minSmallestWidthCascading = this.mContext.getResources().getDimensionPixelSize(C0005R.dimen.abc_cascading_menus_min_smallest_width);
