...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray b = context.getTheme().obtainStyledAttributes(null, new int[]{R.attr.divider}, C0005R.attr.dropDownListViewStyle, 0);
    ...
    protected void onFinishInflate() {
        ...
        this.mShortcutView = (TextView) findViewById(C0005R.id.shortcut);
        ImageView imageView = (ImageView) findViewById(C0005R.id.submenuarrow);
        this.mSubMenuArrowView = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.mSubMenuArrow);
        }
        this.mGroupDivider = (ImageView) findViewById(C0005R.id.group_divider);
        this.mContent = (LinearLayout) findViewById(C0005R.id.content);
    }
    ...
    private void insertIconView() {
        ...
        ImageView imageView = (ImageView) inflater.inflate(C0005R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
    ...
    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton radioButton = (RadioButton) inflater.inflate(C0005R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
    ...
    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox checkBox = (CheckBox) inflater.inflate(C0005R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
