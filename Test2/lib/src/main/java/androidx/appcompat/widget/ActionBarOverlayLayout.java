...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0005R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!this.mOverlayMode && !stable) {
            ...
            Insets sysWindow = Insets.m4of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + topInset, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0005R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0005R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0005R.id.action_bar));
        }
    }
