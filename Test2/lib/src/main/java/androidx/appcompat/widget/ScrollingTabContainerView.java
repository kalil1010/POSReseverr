...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0005R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0005R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        RunnableC00691 runnableC00691 = new Runnable() { // from class: androidx.appcompat.widget.ScrollingTabContainerView.1
            final /* synthetic */ View val$tabView;

            RunnableC00691(View tabView2) {
                view = tabView2;
            }
        ...
        this.mTabSelector = runnableC00691;
        post(runnableC00691);
    }
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean forList) {
            super(context, null, C0005R.attr.actionBarTabStyle);
            int[] iArr = {R.attr.background};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, iArr, C0005R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView2 = new AppCompatTextView(getContext(), null, C0005R.attr.actionBarTabTextStyle);
