...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) throws Resources.NotFoundException, IllegalArgumentException {
        ...
        PorterDuff.Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0005R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        PorterDuff.Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0005R.styleable.SwitchCompat_trackTintMode, -1), null);
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        int typefaceIndex = appearance.getInt(C0005R.styleable.TextAppearance_android_typeface, -1);
        int styleIndex = appearance.getInt(C0005R.styleable.TextAppearance_android_textStyle, -1);
        setSwitchTypefaceByIndex(typefaceIndex, styleIndex);
        boolean allCaps = appearance.getBoolean(C0005R.styleable.TextAppearance_textAllCaps, false);
        if (allCaps) {
