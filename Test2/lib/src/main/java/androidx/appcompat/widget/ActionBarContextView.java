...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C0005R.layout.abc_action_bar_title_item, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(C0005R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0005R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View closeButton = this.mClose.findViewById(C0005R.id.action_mode_close_button);
