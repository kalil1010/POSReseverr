...
public class Toolbar extends ViewGroup {
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0005R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            AppCompatImageButton appCompatImageButton = new AppCompatImageButton(getContext(), null, C0005R.attr.toolbarNavigationButtonStyle);
    ...
    */
    protected void onLayout(boolean r34, int r35, int r36, int r37, int r38) throws java.lang.NoSuchFieldException {
        /*
