...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0005R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0005R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0005R.style.Animation_AppCompat_Tooltip;
