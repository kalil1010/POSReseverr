...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int layoutResId = a.getResourceId(C0005R.styleable.SearchView_layout, C0005R.layout.abc_search_view);
        ...
        this.mSearchEditFrame = findViewById(C0005R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0005R.id.search_plate);
        this.mSubmitArea = findViewById(C0005R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0005R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0005R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0005R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0005R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0005R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0005R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0005R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0005R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0005R.string.abc_searchview_description_search));
        ...
        boolean focusable = a.getBoolean(C0005R.styleable.SearchView_android_focusable, true);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            if (data2 != null && (id = SuggestionsAdapter.getColumnString(c, "suggest_intent_data_id")) != null) {
                data = data2 + TrackUtils.CARD_HOLDER_NAME_SEPARATOR + Uri.encode(id);
            } else {
                data = data2;
            }
