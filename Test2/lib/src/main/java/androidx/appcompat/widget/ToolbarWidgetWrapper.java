...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0005R.string.abc_action_bar_up_description, C0005R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, C0005R.styleable.ActionBar, C0005R.attr.actionBarStyle, 0);
    ...
    class ViewOnClickListenerC00871 implements View.OnClickListener {
        final ActionMenuItem mNavItem;
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (this.mActionMenuPresenter == null) {
            ...
            actionMenuPresenter.setId(C0005R.id.action_menu_presenter);
        }
    ...
    private void ensureSpinner() {
        if (this.mSpinner == null) {
            this.mSpinner = new AppCompatSpinner(getContext(), null, C0005R.attr.actionDropDownStyle);
    ...
    class C00882 extends ViewPropertyAnimatorListenerAdapter {
        private boolean mCanceled = false;
        final /* synthetic */ int val$visibility;
