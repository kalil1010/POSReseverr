...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ImageView iconRefine = (ImageView) v.findViewById(C0005R.id.edit_query);
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0005R.id.edit_query);
        }
    }
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) throws NumberFormatException, IOException {
        ...
        try {
            ...
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + TrackUtils.CARD_HOLDER_NAME_SEPARATOR + resourceId;
