...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0005R.attr.spinnerStyle, mode);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0005R.styleable.Spinner, defStyleAttr, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0005R.styleable.Spinner_popupTheme, 0);
        ...
        if (mode == 0) {
            ...
            dialogPopup.setPromptText(a.getString(C0005R.styleable.Spinner_android_prompt));
        } else if (mode == 1) {
            final DropdownPopup popup = new DropdownPopup(this.mPopupContext, attrs, defStyleAttr);
            TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0005R.styleable.Spinner, defStyleAttr, 0);
            this.mDropDownWidth = pa.getLayoutDimension(C0005R.styleable.Spinner_android_dropDownWidth, -2);
            popup.setBackgroundDrawable(pa.getDrawable(C0005R.styleable.Spinner_android_popupBackground));
            popup.setPromptText(a.getString(C0005R.styleable.Spinner_android_prompt));
            pa.recycle();
            this.mPopup = popup;
        ...
        CharSequence[] entries = a.getTextArray(C0005R.styleable.Spinner_android_entries);
        if (entries != null) {
            ArrayAdapter<CharSequence> adapter = new ArrayAdapter<>(context, R.layout.simple_spinner_item, entries);
            adapter.setDropDownViewResource(C0005R.layout.support_simple_spinner_dropdown_item);
