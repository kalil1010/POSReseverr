...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(C0005R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks();
        View viewFindViewById = findViewById(C0005R.id.activity_chooser_view_content);
        this.mActivityChooserContent = viewFindViewById;
        this.mActivityChooserContentBackground = viewFindViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0005R.id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0005R.id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0005R.id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0005R.id.image);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView = (TextView) convertView2.findViewById(C0005R.id.title);
                        titleView.setText(ActivityChooserView.this.getContext().getString(C0005R.string.abc_activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                }
            ...
            if (convertView == null || convertView.getId() != C0005R.id.list_item) {
            ...
            ImageView iconView = (ImageView) convertView.findViewById(C0005R.id.icon);
            ResolveInfo activity = (ResolveInfo) getItem(position);
            iconView.setImageDrawable(activity.loadIcon(packageManager));
            TextView titleView2 = (TextView) convertView.findViewById(C0005R.id.title);
