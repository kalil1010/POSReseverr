...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    */
    ...
    private static class SavedState implements Parcelable {
        ...
        class C00491 implements Parcelable.Creator<SavedState> {
            C00491() {
            }
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        public OverflowMenuButton(Context context) {
            super(context, null, C0005R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            ...
            setOnTouchListener(new ForwardingListener(this) { // from class: androidx.appcompat.widget.ActionMenuPresenter.OverflowMenuButton.1
                ...
                C00481(View this, ActionMenuPresenter actionMenuPresenter) {
                    super(this);
        ...
        class C00481 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;
