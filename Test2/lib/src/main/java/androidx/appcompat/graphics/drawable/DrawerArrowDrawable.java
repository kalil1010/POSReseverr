...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0005R.styleable.DrawerArrowToggle, C0005R.attr.drawerArrowStyle, C0005R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        ...
        setGapSize(Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0005R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
