...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        if (IS_PRE_LOLLIPOP && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.1
                ...
                C00161(Thread.UncaughtExceptionHandler defHandler2) {
    ...
    class C00161 implements Thread.UncaughtExceptionHandler {
        final /* synthetic */ Thread.UncaughtExceptionHandler val$defHandler;
    ...
    */
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (a.getBoolean(C0005R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (a.getBoolean(C0005R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (a.getBoolean(C0005R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (a.getBoolean(C0005R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = a.getBoolean(C0005R.styleable.AppCompatTheme_android_windowIsFloating, false);
        a.recycle();
        ensureWindow();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0005R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0005R.attr.actionBarTheme, outValue, true);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0005R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) subDecor.findViewById(C0005R.id.decor_content_parent);
            ...
            subDecor = this.mOverlayActionMode ? (ViewGroup) inflater.inflate(C0005R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) inflater.inflate(C0005R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (subDecor == null) {
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C0005R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0005R.id.action_bar_activity_content);
    ...
    class C00183 implements OnApplyWindowInsetsListener {
        C00183() {
        }
    ...
    class C00194 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        C00194() {
        }
    ...
    class C00205 implements ContentFrameLayout.OnAttachListener {
        C00205() {
        }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0005R.id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    class RunnableC00216 implements Runnable {
        RunnableC00216() {
        }
    ...
    class C00227 extends ViewPropertyAnimatorListenerAdapter {
        C00227() {
        }
    ...
    public View createView(View view, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            TypedArray a = this.mContext.obtainStyledAttributes(C0005R.styleable.AppCompatTheme);
            String viewInflaterClassName = a.getString(C0005R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    */
    ...
    private void updateStatusGuardColor(View v) {
        ...
        if (lightStatusBar) {
            color = ContextCompat.getColor(this.mContext, C0005R.color.abc_decor_view_status_guard_light);
        } else {
            color = ContextCompat.getColor(this.mContext, C0005R.color.abc_decor_view_status_guard);
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C00231 extends ViewPropertyAnimatorListenerAdapter {
            C00231() {
            }
    ...
    protected static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0005R.layout.abc_list_menu_item_layout);
        ...
        private static class SavedState implements Parcelable {
            ...
            class C00251 implements Parcelable.ClassLoaderCreator<SavedState> {
                C00251() {
                }
