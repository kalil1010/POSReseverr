...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0005R.styleable.AlertDialog, C0005R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C0005R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0005R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0005R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0005R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0005R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0005R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0005R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0005R.id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer2 = contentPanel.findViewById(C0005R.id.textSpacerNoButtons)) != null) {
        ...
        if (hasTopPanel) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                divider = topPanel.findViewById(C0005R.id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null && (spacer = contentPanel.findViewById(C0005R.id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0005R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0005R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0005R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0005R.id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0005R.id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0005R.id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0005R.id.scrollView);
