...
public abstract class CoroutineContextImpl2<B extends CoroutineContext.Element, E extends B> implements CoroutineContext.Key<E> {
    private final Functions2<CoroutineContext.Element, E> safeCast;
    ...
    public CoroutineContextImpl2(CoroutineContext.Key<B> baseKey, Functions2<? super CoroutineContext.Element, ? extends E> safeCast) {
        Intrinsics.checkNotNullParameter(baseKey, "baseKey");
        Intrinsics.checkNotNullParameter(safeCast, "safeCast");
        this.safeCast = safeCast;
        this.topmostKey = baseKey instanceof CoroutineContextImpl2 ? ((CoroutineContextImpl2) baseKey).topmostKey : baseKey;
    }
