...
public final class Continuation3 {
    ...
    private static final <T> void resumeWithException(Continuation<? super T> continuation, Throwable exception) {
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m76constructorimpl(Result2.createFailure(exception)));
    }

    private static final <T> Continuation<T> Continuation(final CoroutineContext context, final Functions2<? super Result<? extends T>, Unit> functions2) {
        return new Continuation<T>() { // from class: kotlin.coroutines.ContinuationKt.Continuation.1
            ...
            public void resumeWith(Object result) {
                functions2.invoke(Result.m75boximpl(result));
            }
        };
    }

    public static final <T> Continuation<Unit> createCoroutine(Functions2<? super Continuation<? super T>, ? extends Object> createCoroutine, Continuation<? super T> completion) {
    ...
    public static final <R, T> Continuation<Unit> createCoroutine(Functions13<? super R, ? super Continuation<? super T>, ? extends Object> createCoroutine, R r, Continuation<? super T> completion) {
        Intrinsics.checkNotNullParameter(createCoroutine, "$this$createCoroutine");
        Intrinsics.checkNotNullParameter(completion, "completion");
    ...
    public static final <T> void startCoroutine(Functions2<? super Continuation<? super T>, ? extends Object> startCoroutine, Continuation<? super T> completion) {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuationIntercepted.resumeWith(Result.m76constructorimpl(unit));
    }

    public static final <R, T> void startCoroutine(Functions13<? super R, ? super Continuation<? super T>, ? extends Object> startCoroutine, R r, Continuation<? super T> completion) {
        Intrinsics.checkNotNullParameter(startCoroutine, "$this$startCoroutine");
        Intrinsics.checkNotNullParameter(completion, "completion");
    ...
    private static final <T> Object suspendCoroutine(Functions2<? super Continuation<? super T>, Unit> functions2, Continuation<? super T> continuation) throws Throwable {
        InlineMarker.mark(0);
        SafeContinuationJvm safe = new SafeContinuationJvm(IntrinsicsKt.intercepted(continuation));
        functions2.invoke(safe);
