...
public final class CoroutineContextImpl3 implements CoroutineContext, Serializable {
    ...
    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        ...
        while (true) {
            CoroutineContextImpl3 coroutineContextImpl3 = (CoroutineContextImpl3) coroutineContext;
            E e = (E) coroutineContextImpl3.element.get(key);
            if (e != null) {
                return e;
            }
            CoroutineContext coroutineContext2 = coroutineContextImpl3.left;
            if (coroutineContext2 instanceof CoroutineContextImpl3) {
    ...
    @Override // kotlin.coroutines.CoroutineContext
    public <R> R fold(R initial, Functions13<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        ...
        return newLeft == this.left ? this : newLeft == CoroutineContextImpl5.INSTANCE ? this.element : new CoroutineContextImpl3(newLeft, this.element);
    }

    private final int size() {
        CoroutineContextImpl3 cur = this;
        int size = 2;
        while (true) {
    ...
    private final boolean containsAll(CoroutineContextImpl3 context) {
        CoroutineContextImpl3 cur = context;
        while (contains(cur.element)) {
            CoroutineContext next = cur.left;
            if (next instanceof CoroutineContextImpl3) {
                cur = (CoroutineContextImpl3) next;
            } else {
                if (next != null) {
    ...
    public boolean equals(Object other) {
        return this == other || ((other instanceof CoroutineContextImpl3) && ((CoroutineContextImpl3) other).size() == size() && ((CoroutineContextImpl3) other).containsAll(this));
    }
    ...
    public String toString() {
        return "[" + ((String) fold("", new Functions13<String, CoroutineContext.Element, String>() { // from class: kotlin.coroutines.CombinedContext.toString.1
    ...
    private final Object writeReplace() {
        ...
        index.element = 0;
        fold(Unit.INSTANCE, new Functions13<Unit, CoroutineContext.Element, Unit>() { // from class: kotlin.coroutines.CombinedContext.writeReplace.1
    ...
    /* compiled from: CoroutineContextImpl.kt */
    @Metadata(m15bv = {1, 0, 3}, m16d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \f2\u00060\u0001j\u0002`\u0002:\u0001\fB\u0013\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0002\u0010\u0006J\b\u0010\n\u001a\u00020\u000bH\u0002R\u0019\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\b¨\u0006\r"}, m17d2 = {"Lkotlin/coroutines/CombinedContext$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "elements", "", "Lkotlin/coroutines/CoroutineContext;", "([Lkotlin/coroutines/CoroutineContext;)V", "getElements", "()[Lkotlin/coroutines/CoroutineContext;", "[Lkotlin/coroutines/CoroutineContext;", "readResolve", "", "Companion", "kotlin-stdlib"}, m18k = 1, m19mv = {1, 4, 0})
    ...
    private static final class Serialized implements Serializable {
        ...
        private final Object readResolve() {
            ...
            Object initial$iv = CoroutineContextImpl5.INSTANCE;
