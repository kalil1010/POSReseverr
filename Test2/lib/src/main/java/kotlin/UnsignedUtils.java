...
public final class UnsignedUtils {
    ...
    public static final int m391uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m162constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }
    ...
    public static final long m393ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m232constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m232constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m232constructorimpl((ulongCompare(ULong.m232constructorimpl(rem), ULong.m232constructorimpl(v2)) < 0 ? 0 : 1) + quotient);
    }
    ...
    public static final long m394ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (ulongCompare(ULong.m232constructorimpl(rem), ULong.m232constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m232constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= d ? UInt.m162constructorimpl((int) v) : UInt.m162constructorimpl(UInt.m162constructorimpl((int) (v - d)) + UInt.m162constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < ((double) PrimitiveCompanionObjects8.MAX_VALUE) ? ULong.m232constructorimpl((long) v) : ULong.m232constructorimpl(ULong.m232constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
