...
/* renamed from: kotlin.sequences.SequencesKt___SequencesKt$asIterable$$inlined$Iterable$1, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables12<T> implements Iterable<T>, KMarkers {
    final /* synthetic */ Sequence $this_asIterable$inlined;

    public Iterables12(Sequence sequence) {
