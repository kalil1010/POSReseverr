...
class FileReadWrite2 extends FilePathComponents2 {
    ...
    public static final String readText(File readText, Charset charset) throws IOException {
        ...
        try {
            ...
            String text = ReadWrite2.readText(it);
    ...
    public static final void forEachBlock(File forEachBlock, Functions13<? super byte[], ? super Integer, Unit> action) {
    ...
    public static final void forEachBlock(File forEachBlock, int blockSize, Functions13<? super byte[], ? super Integer, Unit> action) throws IOException {
        Intrinsics.checkNotNullParameter(forEachBlock, "$this$forEachBlock");
        Intrinsics.checkNotNullParameter(action, "action");
    ...
    public static /* synthetic */ void forEachLine$default(File file, Charset charset, Functions2 functions2, int i, Object obj) {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        FilesKt.forEachLine(file, charset, functions2);
    }

    public static final void forEachLine(File forEachLine, Charset charset, Functions2<? super String, Unit> action) throws IOException {
    ...
    public static final List<String> readLines(File readLines, Charset charset) {
        ...
        FilesKt.forEachLine(readLines, charset, new Functions2<String, Unit>() { // from class: kotlin.io.FilesKt__FileReadWriteKt.readLines.1
    ...
    public static /* synthetic */ Object useLines$default(File useLines, Charset charset, Functions2 block, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    public static final <T> T useLines(File useLines, Charset charset, Functions2<? super Sequence<String>, ? extends T> block) throws IOException {
        Intrinsics.checkNotNullParameter(useLines, "$this$useLines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(block, "block");
        Reader inputStreamReader = new InputStreamReader(new FileInputStream(useLines), charset);
