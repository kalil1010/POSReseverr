...
public final class Console {
    ...
    public static final String readLine() {
        Console2 console2 = Console2.INSTANCE;
        ...
        return console2.readLine(inputStream, charsetDefaultCharset);
    }
}
