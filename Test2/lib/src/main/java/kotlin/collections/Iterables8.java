...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$8, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables8 implements Iterable<Boolean>, KMarkers {
    final /* synthetic */ boolean[] $this_asIterable$inlined;

    public Iterables8(boolean[] zArr) {
