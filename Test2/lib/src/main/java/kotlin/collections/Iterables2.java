...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$2, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables2 implements Iterable<Byte>, KMarkers {
    final /* synthetic */ byte[] $this_asIterable$inlined;

    public Iterables2(byte[] bArr) {
