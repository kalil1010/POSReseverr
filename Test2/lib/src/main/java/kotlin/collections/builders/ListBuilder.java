...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, KMarkers5 {
    ...
    public ListBuilder(int initialCapacity) {
        this(ListBuilder2.arrayOfUninitializedElements(initialCapacity), 0, 0, false, null, null);
    }
    ...
    private final void ensureCapacity(int minCapacity) {
        ...
        if (minCapacity > this.array.length) {
            this.array = (E[]) ListBuilder2.copyOfUninitializedElements(this.array, ArrayDeque.INSTANCE.newCapacity$kotlin_stdlib(this.array.length, minCapacity));
        }
    }
    ...
    @Override // java.util.AbstractList, java.util.Collection, java.util.List
    public int hashCode() {
        return ListBuilder2.subarrayContentHashCode(this.array, this.offset, this.length);
    }

    @Override // java.util.AbstractCollection
    public String toString() {
        return ListBuilder2.subarrayContentToString(this.array, this.offset, this.length);
    }
    ...
    private final boolean contentEquals(List<?> other) {
        return ListBuilder2.subarrayContentEquals(this.array, this.offset, this.length, other);
    }
    ...
    private final E removeAtInternal(int i) {
        ...
        ListBuilder2.resetAt(this.array, (this.offset + this.length) - 1);
        this.length--;
        return e;
    }
    ...
    private final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        E[] eArr3 = this.array;
        int i2 = this.length;
        ListBuilder2.resetRange(eArr3, i2 - removed2, i2);
        this.length -= removed2;
        return removed2;
    }

    /* compiled from: ListBuilder.kt */
    @Metadata(m15bv = {1, 0, 3}, m16d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010+\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\t\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001d\b\u0016\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0015\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fJ\t\u0010\r\u001a\u00020\u000eH\u0096\u0002J\b\u0010\u000f\u001a\u00020\u000eH\u0016J\u000e\u0010\u0010\u001a\u00028\u0001H\u0096\u0002¢\u0006\u0002\u0010\u0011J\b\u0010\u0012\u001a\u00020\u0006H\u0016J\r\u0010\u0013\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\u0011J\b\u0010\u0014\u001a\u00020\u0006H\u0016J\b\u0010\u0015\u001a\u00020\nH\u0016J\u0015\u0010\u0016\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00028\u0001H\u0016¢\u0006\u0002\u0010\fR\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, m17d2 = {"Lkotlin/collections/builders/ListBuilder$Itr;", "E", "", "list", "Lkotlin/collections/builders/ListBuilder;", "index", "", "(Lkotlin/collections/builders/ListBuilder;I)V", "lastIndex", "add", "", "element", "(Ljava/lang/Object;)V", "hasNext", "", "hasPrevious", "next", "()Ljava/lang/Object;", "nextIndex", "previous", "previousIndex", "remove", "set", "kotlin-stdlib"}, m18k = 1, m19mv = {1, 4, 0})
