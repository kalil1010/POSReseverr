...
public class MapsJVM extends MapWithDefault3 {
    ...
    private static final <K, V> Map<K, V> buildMapInternal(Functions2<? super Map<K, V>, Unit> functions2) {
        Map mapCreateMapBuilder = MapsKt.createMapBuilder();
        functions2.invoke(mapCreateMapBuilder);
        return MapsKt.build(mapCreateMapBuilder);
    }

    private static final <K, V> Map<K, V> buildMapInternal(int capacity, Functions2<? super Map<K, V>, Unit> functions2) {
