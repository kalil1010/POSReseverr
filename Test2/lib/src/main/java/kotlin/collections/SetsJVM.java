...
public class SetsJVM {
    ...
    private static final <E> Set<E> buildSetInternal(Functions2<? super Set<E>, Unit> functions2) {
        Set setCreateSetBuilder = SetsKt.createSetBuilder();
        functions2.invoke(setCreateSetBuilder);
        return SetsKt.build(setCreateSetBuilder);
    }

    private static final <E> Set<E> buildSetInternal(int capacity, Functions2<? super Set<E>, Unit> functions2) {
