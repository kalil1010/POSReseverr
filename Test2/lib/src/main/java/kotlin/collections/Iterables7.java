...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$7, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables7 implements Iterable<Double>, KMarkers {
    final /* synthetic */ double[] $this_asIterable$inlined;

    public Iterables7(double[] dArr) {
