...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$5, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables5 implements Iterable<Long>, KMarkers {
    final /* synthetic */ long[] $this_asIterable$inlined;

    public Iterables5(long[] jArr) {
