...
public class Maps2 extends MapsJVM {
    ...
    private static final <K, V> Map<K, V> buildMap(Functions2<? super Map<K, V>, Unit> functions2) {
        Map mapCreateMapBuilder = MapsKt.createMapBuilder();
        functions2.invoke(mapCreateMapBuilder);
        return MapsKt.build(mapCreateMapBuilder);
    }

    private static final <K, V> Map<K, V> buildMap(int capacity, Functions2<? super Map<K, V>, Unit> functions2) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <K, V, R, M extends Map<? super K, ? super R>> M mapValuesTo(Map<? extends K, ? extends V> mapValuesTo, M destination, Functions2<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <K, V, R, M extends Map<? super R, ? super V>> M mapKeysTo(Map<? extends K, ? extends V> mapKeysTo, M destination, Functions2<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <K, V, R> Map<K, R> mapValues(Map<? extends K, ? extends V> mapValues, Functions2<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <K, V, R> Map<R, V> mapKeys(Map<? extends K, ? extends V> mapKeys, Functions2<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
    ...
    public static final <K, V> Map<K, V> filterKeys(Map<? extends K, ? extends V> filterKeys, Functions2<? super K, Boolean> predicate) {
    ...
    public static final <K, V> Map<K, V> filterValues(Map<? extends K, ? extends V> filterValues, Functions2<? super V, Boolean> predicate) {
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M filterTo(Map<? extends K, ? extends V> filterTo, M destination, Functions2<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
    ...
    public static final <K, V> Map<K, V> filter(Map<? extends K, ? extends V> filter, Functions2<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M filterNotTo(Map<? extends K, ? extends V> filterNotTo, M destination, Functions2<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
    ...
    public static final <K, V> Map<K, V> filterNot(Map<? extends K, ? extends V> filterNot, Functions2<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
