...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$6, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables6 implements Iterable<Float>, KMarkers {
    final /* synthetic */ float[] $this_asIterable$inlined;

    public Iterables6(float[] fArr) {
