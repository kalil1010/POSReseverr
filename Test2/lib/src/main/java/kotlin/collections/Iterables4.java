...
/* renamed from: kotlin.collections.ArraysKt___ArraysKt$asIterable$$inlined$Iterable$4, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables4 implements Iterable<Integer>, KMarkers {
    final /* synthetic */ int[] $this_asIterable$inlined;

    public Iterables4(int[] iArr) {
