...
public class Collections2 extends CollectionsJVM {
    ...
    private static final <T> List<T> List(int size, Functions2<? super Integer, ? extends T> functions2) {
        ArrayList arrayList = new ArrayList(size);
        for (int i = 0; i < size; i++) {
            arrayList.add(functions2.invoke(Integer.valueOf(i)));
        }
        return arrayList;
    }

    private static final <T> List<T> MutableList(int size, Functions2<? super Integer, ? extends T> functions2) {
        ArrayList list = new ArrayList(size);
        for (int i = 0; i < size; i++) {
            int index = i;
            list.add(functions2.invoke(Integer.valueOf(index)));
        }
        return list;
    }

    private static final <E> List<E> buildList(Functions2<? super List<E>, Unit> functions2) {
        List listCreateListBuilder = CollectionsKt.createListBuilder();
        functions2.invoke(listCreateListBuilder);
        return CollectionsKt.build(listCreateListBuilder);
    }

    private static final <E> List<E> buildList(int capacity, Functions2<? super List<E>, Unit> functions2) {
        List listCreateListBuilder = CollectionsKt.createListBuilder(capacity);
        functions2.invoke(listCreateListBuilder);
        return CollectionsKt.build(listCreateListBuilder);
    }

    public static final Ranges6 getIndices(Collection<?> indices) {
        Intrinsics.checkNotNullParameter(indices, "$this$indices");
        return new Ranges6(0, indices.size() - 1);
    }
    ...
    public static /* synthetic */ int binarySearchBy$default(List binarySearchBy, Comparable key, int fromIndex, int toIndex, Functions2 selector, int i, Object obj) {
        if ((i & 2) != 0) {
            fromIndex = 0;
        }
        if ((i & 4) != 0) {
        ...
        return CollectionsKt.binarySearch(binarySearchBy, fromIndex, toIndex, new C04281(selector, key));
    }

    /* compiled from: Collections.kt */
    @Metadata(m15bv = {1, 0, 3}, m16d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000f\n\u0002\b\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u000e\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\n¢\u0006\u0004\b\u0006\u0010\u0007"}, m17d2 = {"<anonymous>", "", "T", "K", "", "it", "invoke", "(Ljava/lang/Object;)I"}, m18k = 3, m19mv = {1, 4, 0})
    /* renamed from: kotlin.collections.CollectionsKt__CollectionsKt$binarySearchBy$1 */
    public static final class C04281<T> extends Lambda implements Functions2<T, Integer> {
        final /* synthetic */ Comparable $key;
        final /* synthetic */ Functions2 $selector;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C04281(Functions2 functions2, Comparable comparable) {
            super(1);
        ...
        public /* bridge */ /* synthetic */ Integer invoke(Object obj) {
            return Integer.valueOf(invoke2((C04281<T>) obj));
        }
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(List<? extends T> binarySearchBy, K k, int fromIndex, int toIndex, Functions2<? super T, ? extends K> selector) {
        Intrinsics.checkNotNullParameter(binarySearchBy, "$this$binarySearchBy");
        Intrinsics.checkNotNullParameter(selector, "selector");
        return CollectionsKt.binarySearch(binarySearchBy, fromIndex, toIndex, new C04281(selector, k));
    }

    public static /* synthetic */ int binarySearch$default(List list, int i, int i2, Functions2 functions2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return CollectionsKt.binarySearch(list, i, i2, functions2);
    }

    public static final <T> int binarySearch(List<? extends T> binarySearch, int fromIndex, int toIndex, Functions2<? super T, Integer> comparison) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
