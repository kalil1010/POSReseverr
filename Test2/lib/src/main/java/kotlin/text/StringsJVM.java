...
public class StringsJVM extends StringNumberConversions {
    ...
    private static final String format(PrimitiveCompanionObjects10 $this$format, String format, Object... args) {
    ...
    @Annotations(message = "Use Kotlin compiler 1.4 to avoid deprecation warning.")
    @Annotations2(hiddenSince = "1.4")
    private static final /* synthetic */ String format(PrimitiveCompanionObjects10 $this$format, Locale locale, String format, Object... args) {
        String str = String.format(locale, format, Arrays.copyOf(args, args.length));
        Intrinsics.checkNotNullExpressionValue(str, "java.lang.String.format(locale, format, *args)");
        return str;
    }

    private static final String formatNullable(PrimitiveCompanionObjects10 $this$format, Locale locale, String format, Object... args) {
        String str = String.format(locale, format, Arrays.copyOf(args, args.length));
        Intrinsics.checkNotNullExpressionValue(str, "java.lang.String.format(locale, format, *args)");
        return str;
    }
    ...
    public static final boolean isBlank(CharSequence isBlank) {
        ...
        if (isBlank.length() != 0) {
            ...
            if (!($this$all$iv instanceof Collection) || !((Collection) $this$all$iv).isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        int element$iv = ((Iterators8) it).nextInt();
    ...
    public static final Comparator<String> getCASE_INSENSITIVE_ORDER(PrimitiveCompanionObjects10 CASE_INSENSITIVE_ORDER) {
