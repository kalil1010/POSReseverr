...
/* renamed from: kotlin.text.StringsKt___StringsKt$asIterable$$inlined$Iterable$1, reason: use source file name */
/* loaded from: classes.dex */
public final class Iterables13 implements Iterable<Character>, KMarkers {
    final /* synthetic */ CharSequence $this_asIterable$inlined;

    public Iterables13(CharSequence charSequence) {
