...
public class ULongRange2 implements Iterable<ULong>, KMarkers {
    ...
    private ULongRange2(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtil.m1242getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM232constructorimpl = ((int) ULong.m232constructorimpl(j ^ ULong.m232constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM232constructorimpl2 = (iM232constructorimpl + ((int) ULong.m232constructorimpl(j2 ^ ULong.m232constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM232constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m269toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m269toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    /* compiled from: ULongRange.kt */
    @Metadata(m15bv = {1, 0, 3}, m16d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, m17d2 = {"Lkotlin/ranges/ULongProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/ULongProgression;", "rangeStart", "Lkotlin/ULong;", "rangeEnd", "step", "", "fromClosedRange-7ftBX0g", "(JJJ)Lkotlin/ranges/ULongProgression;", "kotlin-stdlib"}, m18k = 1, m19mv = {1, 4, 0})
    ...
    public static final class Companion {
        ...
        public final ULongRange2 m1265fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
