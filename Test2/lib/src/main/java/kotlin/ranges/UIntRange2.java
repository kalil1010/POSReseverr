...
public class UIntRange2 implements Iterable<UInt>, KMarkers {
    ...
    private UIntRange2(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtil.m1243getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m199toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m199toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    /* compiled from: UIntRange.kt */
    @Metadata(m15bv = {1, 0, 3}, m16d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, m17d2 = {"Lkotlin/ranges/UIntProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/UIntProgression;", "rangeStart", "Lkotlin/UInt;", "rangeEnd", "step", "", "fromClosedRange-Nkh28Cs", "(III)Lkotlin/ranges/UIntProgression;", "kotlin-stdlib"}, m18k = 1, m19mv = {1, 4, 0})
    ...
    public static final class Companion {
        ...
        public final UIntRange2 m1259fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
