...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        return new TypeAdapter<T>() { // from class: com.google.gson.internal.Excluder.1
            ...
            C03481(boolean skipDeserialize2, boolean skipSerialize2, Gson gson2, TypeToken type2) {
                z = skipDeserialize2;
                z = skipSerialize2;
                gson = gson2;
                typeToken = type2;
    ...
    class C03481<T> extends TypeAdapter<T> {
        private TypeAdapter<T> delegate;
        final /* synthetic */ Gson val$gson;
        final /* synthetic */ boolean val$skipDeserialize;
        final /* synthetic */ boolean val$skipSerialize;
