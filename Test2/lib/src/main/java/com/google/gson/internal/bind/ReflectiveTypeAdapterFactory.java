...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        return new BoundField(name, serialize, deserialize) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
            ...
            C03651(String name2, boolean serialize2, boolean deserialize2, Field field2, boolean jsonAdapterPresent2, TypeAdapter mapped2, Gson context2, TypeToken fieldType2, boolean isPrimitive2) {
                super(name2, serialize2, deserialize2);
                field = field2;
                z = jsonAdapterPresent2;
                typeAdapter = mapped2;
                gson = context2;
                typeToken = fieldType2;
                z = isPrimitive2;
            }
            ...
            void write(JsonWriter writer, Object value) throws IllegalAccessException, IOException, IllegalArgumentException {
                ...
                TypeAdapter t = z ? typeAdapter : new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter, typeToken.getType());
    ...
    class C03651 extends BoundField {
        final /* synthetic */ Gson val$context;
        final /* synthetic */ Field val$field;
        final /* synthetic */ TypeToken val$fieldType;
        final /* synthetic */ boolean val$isPrimitive;
