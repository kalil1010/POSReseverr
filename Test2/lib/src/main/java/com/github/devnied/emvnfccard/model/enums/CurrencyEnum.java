...
public enum CurrencyEnum implements IKeyEnum {
    ...
    CurrencyEnum(int numeric, Digits digits, String name, CountryCodeEnum[] countries) {
        this.name = name;
    ...
    public String format(long amount) {
        String formatted;
        int i = C03171.f317x42719e07[this.digits.ordinal()];
        if (i == 1) {
            ...
            String formatted2 = a + "." + b;
            formatted = formatted2;
        } else if (i == 3) {
            String a2 = String.valueOf(amount / 1000);
            String b2 = String.valueOf(amount % 1000);
            while (b2.length() < 3) {
                b2 = "0" + b2;
            }
            String formatted3 = a2 + "." + b2;
        ...
        return getCode() + StringUtils.SPACE + formatted;
    }
    ...
    public static CurrencyEnum find(CountryCodeEnum pCountryCodeEnum) {
        ...
        if (pCountryCodeEnum != null) {
            switch (C03171.f316x71b58293[pCountryCodeEnum.ordinal()]) {
                case 1:
                    return BOB;
                case 2:
                    return CHF;
    ...
    /* renamed from: com.github.devnied.emvnfccard.model.enums.CurrencyEnum$1 */
    static /* synthetic */ class C03171 {

        /* renamed from: $SwitchMap$com$github$devnied$emvnfccard$model$enums$CountryCodeEnum */
        static final /* synthetic */ int[] f316x71b58293;

        /* renamed from: $SwitchMap$com$github$devnied$emvnfccard$model$enums$CurrencyEnum$Digits */
        static final /* synthetic */ int[] f317x42719e07;
        ...
        static {
            ...
            try {
                f316x71b58293[CountryCodeEnum.CH.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f316x71b58293[CountryCodeEnum.CL.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f316x71b58293[CountryCodeEnum.MX.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f316x71b58293[CountryCodeEnum.US.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f316x71b58293[CountryCodeEnum.UY.ordinal()] = 6;
            ...
            try {
                f317x42719e07[Digits.DIGITS_2.ordinal()] = 2;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f317x42719e07[Digits.DIGITS_3.ordinal()] = 3;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f317x42719e07[Digits.DIGITS_07.ordinal()] = 4;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f317x42719e07[Digits.DIGITS_NO.ordinal()] = 5;
