...
public enum CountryCodeEnum implements IKeyEnum {
    ...
    GD("Grenada", "GRD", StatusLine.HTTP_PERM_REDIRECT),
    GE("Georgia", "GEO", 268),
    ...
    CountryCodeEnum(String name, String alpha3, int numeric) {
        this.name = name;
        this.alpha3 = alpha3;
    ...
    public static CountryCodeEnum getCountry(String alpha3) {
