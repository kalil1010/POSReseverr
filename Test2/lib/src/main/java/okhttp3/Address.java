...
public final class Address {
    ...
    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "url", imports = {}))
    ...
    public final List<Protocol> m1393deprecated_protocols() {
        return this.protocols;
    }
