...
public final class Challenge {
    ...
    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "authParams", imports = {}))
    /* renamed from: -deprecated_authParams, reason: not valid java name */
    public final Map<String, String> m1411deprecated_authParams() {
        return this.authParams;
    }

    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "realm", imports = {}))
    /* renamed from: -deprecated_realm, reason: not valid java name */
    public final String m1413deprecated_realm() {
        return realm();
    }

    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "charset", imports = {}))
    /* renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m1412deprecated_charset() {
        return charset();
    }
