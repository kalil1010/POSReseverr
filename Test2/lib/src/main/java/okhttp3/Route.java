...
public final class Route {
    ...
    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "address", imports = {}))
    ...
    @Annotations(level = Annotations3.ERROR, message = "moved to val", replaceWith = @Annotations8(expression = "socketAddress", imports = {}))
