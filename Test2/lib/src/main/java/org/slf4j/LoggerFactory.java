...
public final class LoggerFactory {
    ...
    */
    private static void replayEvents() throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
    ...
    private static void replaySingleEvent(SubstituteLoggingEvent event) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (event == null) {
            return;
        }
